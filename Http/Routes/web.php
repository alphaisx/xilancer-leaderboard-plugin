...
Route::group(['middleware' => ['globalVariable', 'maintains_mode', 'setlang'], 'as' => 'frontend.'], function () {
    Route::get('/leaderboard', function () {
        $candidates = Entry::where('is_active', true)->orderBy('position')->limit(20)->with('user')->get();
        return view('rank::frontend.index', compact('candidates'));
    })->name('leaderboard.index');
});


// AMBASSADOR ROUTES
Route::group(['prefix' => 'admin/ambassador', 'middleware' => [
    'auth:admin',
    'setlang',
    'can:manage-ambassadors',
], 'as' => 'admin.'], function () {
